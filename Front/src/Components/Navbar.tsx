...
const Navbar = () => {
  ...
  <>
    ...
    <div className="text-gray-700 text-xl w-1/2 text-center items-center inline-flex">
        <Link to="/home" className="m-auto h-full inline-flex items-center">      
          <img src="src/Assets/Images/logo.png" alt="logo" className="h-16 w-20 mx-4" />
          <span className='text-primary font-semibold text-2xl'>KnowledgeHub</span>      
        </Link>
    </div>
    ...
    <ul className="space-x-4 text-gray-700 w-1/2 text-3xl place-content-center hidden lg:flex">
      ...
      <li>
        <a href="/tests" className="text-2xl text-blue hover:text-gray-500">Tests</a>
      </li>
      <li>
